...
public class PrintResult {
    ...
    public void printErrorMessage(String errorCode) {
        ...
        switch (errorCode) {
            ...
            case "insert" : errorMessage = "몬스터 등록에 실패하였습니다."; break;
            case "update" : errorMessage = "몬스터 수정에 실패하였습니다."; break;
            case "delete" : errorMessage = "몬스터 삭제에 실패하였습니다."; break;
        }
    ...
    public void printSuccessMessage(String successCode) {
        ...
        switch (successCode) {
            case "insert" : successMessage = "신규 몬스터 등록 완료 !"; break;
            case "update" : successMessage = "몬스터정보 수정이 완료 되었습니다."; break;
            case "delete" : successMessage = "몬스터 삭제에 성공.. 잘가.."; break;
        }
